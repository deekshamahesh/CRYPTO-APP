        ...
        ((Button) view.findViewById(R.id.button_key)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              if (difflehellman.this.prime_number_1.getText().toString().equals("") || difflehellman.this.prime_number_2.getText().toString().equals("") || difflehellman.this.secret_SENDER.getText().toString().equals("") || difflehellman.this.secret_RECEIVER.getText().toString().equals("")) {
                ...
                BigInteger valueOf = BigInteger.valueOf(Long.valueOf(difflehellman.this.prime_number_1.getText().toString()).longValue());//p
                double doubleValue = Double.valueOf(difflehellman.this.prime_number_2.getText().toString()).doubleValue();//g
                double doubleValue2 = Double.valueOf(difflehellman.this.secret_SENDER.getText().toString()).doubleValue();//a
                double doubleValue3 = Double.valueOf(difflehellman.this.secret_RECEIVER.getText().toString()).doubleValue();//b

                BigInteger power = difflehellman.this.power(doubleValue, doubleValue2, valueOf);//A=g^a mod p
                BigInteger power2 = difflehellman.this.power(difflehellman.this.power(doubleValue, doubleValue3, valueOf).doubleValue(), doubleValue2, valueOf);//g^b mod p
